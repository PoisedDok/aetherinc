...
/**
 * Quick test for Resend using the default domain
 * Run with: node scripts/test-resend-working.js
 */
async function quickTest() {
  ...
  try {
    ...
    const { data, error } = await resend.emails.send({
      ...
      subject: 'Test from Aether Inc (Resend Default Domain)',
      html: `
        <div style="font-family: Arial, sans-serif; padding: 20px; max-width: 600px; margin: 0 auto; border: 1px solid #eee; border-radius: 5px;">
          <h2 style="color: #333;">Email Service Test</h2>
          <p>This is a test email sent from Aether Inc using Resend's default domain.</p>
          <p>To send emails from your own domain (info@aetherinc.xyz), you need to verify your domain with Resend:</p>
          <ol>
            <li>Log in to your Resend dashboard</li>
            <li>Go to Domains section</li>
            <li>Add your domain (aetherinc.xyz)</li>
            <li>Add the DNS records provided by Resend to your domain's DNS settings</li>
            <li>Verify the domain in Resend dashboard</li>
          </ol>
          <p>Once verified, you can send emails from your own domain!</p>
