...
- Interactive interface for text generation with Gemini
...
- Support for various authentication methods:
  ...
  - Vertex AI support
  - Local llama.cpp backend for offline use
- Tool integration for working with local files, executing commands, and more
...
gemini-cli now supports running with local LLMs through llama.cpp integration:

1. Download a GGUF model file (like Meta-Llama-3-8B-Instruct) and place it in the `models/` directory
2. Run gemini-cli: `npm run start`
3. When prompted, select "Local llama.cpp" as the authentication method

The llama.cpp server will start automatically when you select this option. This allows you to use gemini-cli completely offline with local models.

See [llama-cpp.md](docs/tools/llama-cpp.md) for more details.
