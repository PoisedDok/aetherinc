...
// Legacy transporter definition - kept for backward compatibility
// but not actually used anymore
export const transporter = {
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  sendMail: async (options: Record<string, unknown>) => {
    console.warn('Legacy nodemailer transporter used - this is deprecated');
...
export async function sendContactEmail(data: {
  ...
  try {
    ...
    // Try with custom domain, fall back to default domain if not verified
    try {
