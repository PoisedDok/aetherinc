...
export default function DocumentationPage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-black via-blue-950 to-black text-white flex flex-col">
      <Navbar />
      <main className="flex-grow flex flex-col items-center justify-center text-center pt-20 pb-20 px-4 md:px-6">
        ...
        >
          <Clock className="h-16 w-16 md:h-24 md:w-24 mx-auto mb-8 text-blue-400" />
          ...
          <p className="text-lg md:text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
            Detailed documentation for GURU hardware, software SDKs, and APIs is currently under development.
          </p>
          <p className="text-md text-gray-400 mb-10 max-w-lg mx-auto">
             Join the waitlist to get notified as soon as our documentation becomes available.
          </p>
