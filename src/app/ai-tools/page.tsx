  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="container mx-auto px-4 py-12 pt-28">
        ...
        >
          {/* Consulting CTA */}
          <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 border border-blue-500/20 rounded-lg p-8 text-center">
          ...
          {/* Products CTA */}
          <div className="bg-gradient-to-r from-purple-900/20 to-pink-900/20 border border-purple-500/20 rounded-lg p-8 text-center">
            <h3 className="text-2xl font-bold mb-4 text-white">
